  ...
  <nav style="background-color: #030303;" class="navbar navbar-expand-lg navbar-dark border-bottom shadow-sm mb-3">
    <div class="container">
      ...
      <div class="align-self-end">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link text-white" href="?acao=Inicio">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="?acao=Form">Sobre</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="?acao=Admin">Login</a>
          </li>
          <li class="nav-item">
